...
export default function EmployerV4Page({ mode: propMode = 'all' }: EmployerV4ScreenProps) {
  ...
  const step5State: StepState = employee ? (isDelegated ? 'done' : 'active') : 'locked';
      ...
      <div className="space-y-6">
        ...
        {setupOnly ? (
          <section id="setup" className="expensee-steps">
            ...
            {showStep5 ? (
              <div id="high-speed-mode" className="expensee-step-wrap">
                <StepCard
                  number={stepNumberMap[5] ?? 5}
                  title="High-speed mode"
                  description="Delegate the employee stream to MagicBlock, schedule the crank, and manage the real-time lifecycle."
                  state={step5State}
                  collapsible={!setupOnly}
                >
                  <div className="panel-card">
