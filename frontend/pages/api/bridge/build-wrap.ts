...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Ok | Err>) {
  ...
  try {
    ...
    const mintAuthority = loadKeypairFromPath(requiredEnv('BRIDGE_PAYUSD_MINT_AUTHORITY_KEYPAIR_PATH'));
    ...
    const confidentialMint = new PublicKey(
      process.env.BRIDGE_PAYUSD_MINT || process.env.NEXT_PUBLIC_PAYUSD_MINT || ''
    );
