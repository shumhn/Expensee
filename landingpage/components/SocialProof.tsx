...
const testimonials = [
    {
        name: "Sarah J.",
        handle: "@sarah_web3",
        text: "The FHE privacy on @Expensee is a game changer for our remote team. Finally, a way to stream salaries without exposing sensitive data on-chain. Nobody sees what we pay.",
    ...
    },
    {
        ...
        text: "Real-time salary streaming via MagicBlock TEEs has transformed how we handle payroll. Our contractors love seeing their balance grow every second in real-time.",
    ...
    },
    {
        name: "Elena R.",
        handle: "@elena_dao",
        text: "Magic Scan is incredible. I connected my wallet, clicked one button, and it instantly found my employment record. No indexes, no manual setup. Just pure crypto magic.",
    ...
    },
    {
        ...
        text: "Pooled privacy payouts mean my team can withdraw without exposing their wallet-to-employee link. Expensee solves the crypto payroll privacy problem for real.",
